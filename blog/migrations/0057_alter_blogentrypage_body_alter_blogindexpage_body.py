# Generated by Django 5.0.9 on 2024-12-20 14:49
        ...
        migrations.AlterField(
            ...
            field=wagtail.fields.StreamField(
                [
                    ...
                    ("subpageslist", 192),
                    ("blog_recent_entries", 175),
                    ("events_recent_entries", 194),
                    ("three_cards", 212),
                    ("numeric_direction_card", 213),
                    ("spacer", 178),
                    ("stylized_column", 167),
                    ("highlight_cards", 217),
                    ("vertical_highlight_cards", 219),
                    ("slider", 182),
                ],
                blank=True,
                block_lookup={
                    ...
                    152: (
                        "wagtail.blocks.StructBlock",
                        [[("title", 1), ("heading_tag", 2), ("heading_size", 150), ("title_color_class", 151)]],
                        {"group": "Numerique components", "label": "Title"},
                    ),
                    153: ("wagtail.images.blocks.ImageChooserBlock", (), {"label": "Image", "required": True}),
                    154: ("wagtail.blocks.CharBlock", (), {"label": "Alt text", "required": True}),
                    155: ("wagtail.blocks.RichTextBlock", (), {"label": "Text", "required": True}),
                    156: ("wagtail.blocks.PageChooserBlock", (), {"label": "Main link", "required": True}),
                    157: (
                        "wagtail.blocks.URLBlock",
                        (),
                    ...
                    158: (
                        "wagtail.blocks.StructBlock",
                        [[("image", 153), ("alt", 154), ("text", 155), ("main_link", 156), ("secondary_link", 157)]],
                    ...
                    163: (
                        "wagtail.blocks.StructBlock",
                        [[("width", 149), ("content", 162)]],
                        {"group": "Page structure", "label": "Custom adjustable column", "required": False},
                    ),
                    164: ("wagtail.blocks.BooleanBlock", (), {"label": "Border", "required": False}),
                    165: ("wagtail.blocks.BooleanBlock", (), {"label": "Center content", "required": False}),
                    166: (
                        "wagtail.blocks.StreamBlock",
                        [
                            [
                    ...
                    167: (
                        "wagtail.blocks.StructBlock",
                        [[("bg_color_class", 145), ("border", 164), ("center_content", 165), ("content", 166)]],
                    ...
                    182: (
                        "wagtail.blocks.StructBlock",
                        [[("title", 1), ("title_heading_tag", 179), ("title_heading_size", 180), ("blocks", 181)]],
                    ...
                    183: (
                        ...
                        [
                            [
                                ...
                                ("item_grid", 161),
                                ("numeric_direction_card", 158),
                                ("custom_ajustable_column", 163),
                                ("horizontal_card", 99),
                                ("multicolumns", 176),
                                ("stylized_column", 167),
                                ("spacer", 178),
                                ("custom_item_grid", 171),
                                ("slider", 182),
                            ]
                        ],
                        {"label": "Content"},
                    ...
                    184: (
                        "wagtail.blocks.StructBlock",
                        [[("bg_image", 144), ("bg_color_class", 145), ("content", 183)]],
                    ...
                    186: ("wagtail.blocks.CharBlock", (), {"label": "Side menu title", "required": False}),
                    187: (
                        "wagtail.blocks.RawHTMLBlock",
                        (),
                        {
                    ...
                    188: ("wagtail.blocks.PageChooserBlock", (), {"label": "Parent page"}),
                    189: ("wagtail.blocks.StructBlock", [[("page", 188)]], {"label": "Page tree"}),
                    190: (
                        "wagtail.blocks.StreamBlock",
                    ...
                    196: ("wagtail.blocks.TextBlock", (), {"label": "Main card title", "required": True}),
                    197: ("wagtail.blocks.RichTextBlock", (), {"label": "Main card text", "required": True}),
                    198: (
                        "wagtail.blocks.PageChooserBlock",
                        (),
                    ...
                    201: ("wagtail.blocks.TextBlock", (), {"label": "Top right card title", "required": False}),
                    202: ("wagtail.blocks.RichTextBlock", (), {"label": "Top right card text", "required": True}),
                    203: ("wagtail.blocks.TextBlock", (), {"label": "Top right card button label", "required": False}),
                    204: (
                        "wagtail.blocks.PageChooserBlock",
                        (),
                    ...
                    207: ("wagtail.blocks.TextBlock", (), {"label": "Bottom right card title", "required": False}),
                    208: ("wagtail.blocks.RichTextBlock", (), {"label": "Bottom right card text", "required": True}),
                    209: (
                    ...
                    212: (
                        ...
                        [
                            [
                                ...
                                ("top_right_title", 201),
                                ("top_right_text", 202),
                                ("top_right_button_label", 203),
                                ("top_right_page_link", 204),
                                ("top_right_url_link", 205),
                                ("bottom_right_image", 206),
                                ("bottom_right_title", 207),
                                ("bottom_right_text", 208),
                                ("bottom_right_button_label", 209),
                                ("bottom_right_page_link", 210),
                                ("bottom_right_url_link", 211),
                            ]
                        ],
                    ...
                    217: (
                        "wagtail.blocks.StructBlock",
                        [[("main_card", 214), ("secondary_card", 215), ("tertiary_card", 216)]],
                    ...
                    219: (
                        "wagtail.blocks.StructBlock",
                        [[("main_card", 218), ("secondary_card", 215), ("tertiary_card", 216)]],
