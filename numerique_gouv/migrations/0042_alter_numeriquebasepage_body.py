# Generated by Django 5.0.8 on 2024-09-05 11:23
...
class Migration(migrations.Migration):
    dependencies = [
        ("numerique_gouv", "0041_productsentrypage_position"),
    ]
        ...
        migrations.AlterField(
            ...
            field=wagtail.fields.StreamField(
                ...
                block_lookup={
                    ...
                    140: (
                        "wagtail.blocks.StructBlock",
                        [[("title", 1), ("heading_tag", 2), ("heading_size", 138), ("title_color_class", 139)]],
                    ...
                    142: ("wagtail.images.blocks.ImageChooserBlock", (), {"label": "Image", "required": True}),
                    143: ("wagtail.blocks.CharBlock", (), {"label": "Alt text", "required": True}),
                    144: ("wagtail.blocks.RichTextBlock", (), {"label": "Text", "required": True}),
                    145: ("wagtail.blocks.PageChooserBlock", (), {"label": "Main link", "required": True}),
                    146: (
                        "wagtail.blocks.URLBlock",
                        (),
                    ...
                    147: (
                        "wagtail.blocks.StructBlock",
                        [[("image", 142), ("alt", 143), ("text", 144), ("main_link", 145), ("secondary_link", 146)]],
                    ...
                    152: (
                        "wagtail.blocks.StructBlock",
                        [[("width", 137), ("content", 151)]],
                        {"group": "Page structure", "label": "Custom adjustable column", "required": False},
                    ),
                    153: ("wagtail.blocks.BooleanBlock", (), {"label": "Border", "required": False}),
                    154: ("wagtail.blocks.BooleanBlock", (), {"label": "Center content", "required": False}),
                    155: (
                        "wagtail.blocks.StreamBlock",
                        [
                            [
                    ...
                    156: (
                        "wagtail.blocks.StructBlock",
                        [[("bg_color_class", 114), ("border", 153), ("center_content", 154), ("content", 155)]],
                    ...
                    164: (
                        "wagtail.blocks.StructBlock",
                        [[("marginTop", 162), ("marginBottom", 163)]],
                    ...
                    165: (
                        ...
                        [
                            [
                                ...
                                ("html", 141),
                                ("numeric_direction_card", 147),
                                ("custom_ajustable_column", 152),
                                ("horizontal_card", 84),
                                ("multicolumns", 161),
                                ("stylized_column", 156),
                                ("spacer", 164),
                                ("custom_item_grid", 160),
                            ]
                        ],
                        {"label": "Content"},
                    ),
                    166: (
                        "wagtail.blocks.StructBlock",
                        [[("bg_image", 113), ("bg_color_class", 114), ("content", 165)]],
                    ...
                    177: ("wagtail.blocks.TextBlock", (), {"label": "Main card title", "required": True}),
                    178: ("wagtail.blocks.RichTextBlock", (), {"label": "Main card text", "required": True}),
                    179: (
                        "wagtail.blocks.PageChooserBlock",
                        (),
                    ...
                    182: ("wagtail.blocks.TextBlock", (), {"label": "Top right card title", "required": False}),
                    183: ("wagtail.blocks.RichTextBlock", (), {"label": "Top right card text", "required": True}),
                    184: ("wagtail.blocks.TextBlock", (), {"label": "Top right card button label", "required": False}),
                    185: (
                        "wagtail.blocks.PageChooserBlock",
                        (),
                    ...
                    188: ("wagtail.blocks.TextBlock", (), {"label": "Bottom right card title", "required": False}),
                    189: ("wagtail.blocks.RichTextBlock", (), {"label": "Bottom right card text", "required": True}),
                    190: (
                    ...
                    193: (
                        ...
                        [
                            [
                                ...
                                ("top_right_title", 182),
                                ("top_right_text", 183),
                                ("top_right_button_label", 184),
                                ("top_right_page_link", 185),
                                ("top_right_url_link", 186),
                                ("bottom_right_image", 187),
                                ("bottom_right_title", 188),
                                ("bottom_right_text", 189),
                                ("bottom_right_button_label", 190),
                                ("bottom_right_page_link", 191),
                                ("bottom_right_url_link", 192),
                            ]
                        ],
                    ...
                    198: (
                        "wagtail.blocks.StructBlock",
                        [[("main_card", 195), ("secondary_card", 196), ("tertiary_card", 197)]],
