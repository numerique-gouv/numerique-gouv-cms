# Generated by Django 5.0.9 on 2024-10-11 10:03
...
def migrate_target_audience_to_target_audiences(apps, schema_editor):
    products_entry_pages = apps.get_model("numerique_gouv", "ProductSentryPage")
    for page in products_entry_pages.objects.all():
        if page.target_audience:
            page.target_audiences.add(page.target_audience)
            page.save()


class Migration(migrations.Migration):
    dependencies = [
        ("numerique_gouv", "0061_alter_numeriquebasepage_body"),
    ]
    ...
    operations = [
        migrations.AddField(
            ...
            field=modelcluster.fields.ParentalManyToManyField(
                blank=True, null=True, to="numerique_gouv.targetaudience", verbose_name="Target Audiences"
            ),
        ),
        migrations.RunPython(migrate_target_audience_to_target_audiences),
        ...
        migrations.AlterField(
            ...
            field=wagtail.fields.StreamField(
                [
                    ...
                    ("subpageslist", 177),
                    ("blog_recent_entries", 181),
                    ("events_recent_entries", 125),
                    ("html", 182),
                    ("three_cards", 200),
                    ("numeric_direction_card", 201),
                    ("spacer", 167),
                    ("stylized_column", 159),
                    ("highlight_cards", 205),
                ],
                ...
                block_lookup={
                    ...
                    165: (
                        ...
                        (),
                        {"help_text": "In rem", "label": "Margin top", "required": False},
                    ),
                    166: (
                        "wagtail.blocks.DecimalBlock",
                        (),
                        {"help_text": "In rem", "label": "Margin bottom", "required": False},
                    ),
                    167: (
                        "wagtail.blocks.StructBlock",
                        [[("marginTop", 165), ("marginBottom", 166)]],
                    ...
                    169: (
                        "wagtail.blocks.StructBlock",
                        [[("bg_image", 136), ("bg_color_class", 137), ("content", 168)]],
                    ...
                    184: ("wagtail.blocks.TextBlock", (), {"label": "Main card title", "required": True}),
                    185: ("wagtail.blocks.RichTextBlock", (), {"label": "Main card text", "required": True}),
                    186: (
                        "wagtail.blocks.PageChooserBlock",
                        (),
                    ...
                    189: ("wagtail.blocks.TextBlock", (), {"label": "Top right card title", "required": False}),
                    190: ("wagtail.blocks.RichTextBlock", (), {"label": "Top right card text", "required": True}),
                    191: ("wagtail.blocks.TextBlock", (), {"label": "Top right card button label", "required": False}),
                    192: (
                        "wagtail.blocks.PageChooserBlock",
                        (),
                    ...
                    195: ("wagtail.blocks.TextBlock", (), {"label": "Bottom right card title", "required": False}),
                    196: ("wagtail.blocks.RichTextBlock", (), {"label": "Bottom right card text", "required": True}),
                    197: (
                    ...
                    200: (
                        ...
                        [
                            [
                                ...
                                ("top_right_title", 189),
                                ("top_right_text", 190),
                                ("top_right_button_label", 191),
                                ("top_right_page_link", 192),
                                ("top_right_url_link", 193),
                                ("bottom_right_image", 194),
                                ("bottom_right_title", 195),
                                ("bottom_right_text", 196),
                                ("bottom_right_button_label", 197),
                                ("bottom_right_page_link", 198),
                                ("bottom_right_url_link", 199),
                            ]
                        ],
                    ...
                    205: (
                        "wagtail.blocks.StructBlock",
                        [[("main_card", 202), ("secondary_card", 203), ("tertiary_card", 204)]],
