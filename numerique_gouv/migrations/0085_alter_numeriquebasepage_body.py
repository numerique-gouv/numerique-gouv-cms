# Generated by Django 5.0.9 on 2024-11-30 19:41
...
class Migration(migrations.Migration):
    dependencies = [
        ("numerique_gouv", "0084_alter_numeriquebasepage_body"),
    ]
        ...
        migrations.AlterField(
            ...
            field=wagtail.fields.StreamField(
                [
                    ...
                    ("multicolumns", 161),
                    ("item_grid", 163),
                    ("fullwidthbackground", 176),
                    ("fullwidthbackgroundwithsidemenu", 183),
                    ("subpageslist", 184),
                    ("blog_recent_entries", 167),
                    ("events_recent_entries", 186),
                    ("html", 187),
                    ("three_cards", 205),
                    ("numeric_direction_card", 206),
                    ("spacer", 170),
                    ("stylized_column", 159),
                    ("highlight_cards", 210),
                    ("vertical_highlight_cards", 212),
                    ("slider", 174),
                ],
                blank=True,
                block_lookup={
                    ...
                    174: (
                        "wagtail.blocks.StructBlock",
                        [[("title", 1), ("title_heading_tag", 171), ("title_heading_size", 172), ("blocks", 173)]],
                    ...
                    176: (
                        "wagtail.blocks.StructBlock",
                        [[("bg_image", 136), ("bg_color_class", 137), ("content", 175)]],
                    ...
                    178: ("wagtail.blocks.CharBlock", (), {"label": "Side menu title", "required": False}),
                    179: (
                        "wagtail.blocks.RawHTMLBlock",
                        (),
                        {
                    ...
                    180: ("wagtail.blocks.PageChooserBlock", (), {"label": "Parent page"}),
                    181: ("wagtail.blocks.StructBlock", [[("page", 180)]], {"label": "Page tree"}),
                    182: (
                        "wagtail.blocks.StreamBlock",
                        [[("html", 179), ("pagetree", 181)]],
                    ...
                    189: ("wagtail.blocks.TextBlock", (), {"label": "Main card title", "required": True}),
                    190: ("wagtail.blocks.RichTextBlock", (), {"label": "Main card text", "required": True}),
                    191: (
                        "wagtail.blocks.PageChooserBlock",
                        (),
                    ...
                    194: ("wagtail.blocks.TextBlock", (), {"label": "Top right card title", "required": False}),
                    195: ("wagtail.blocks.RichTextBlock", (), {"label": "Top right card text", "required": True}),
                    196: ("wagtail.blocks.TextBlock", (), {"label": "Top right card button label", "required": False}),
                    197: (
                        "wagtail.blocks.PageChooserBlock",
                        (),
                    ...
                    200: ("wagtail.blocks.TextBlock", (), {"label": "Bottom right card title", "required": False}),
                    201: ("wagtail.blocks.RichTextBlock", (), {"label": "Bottom right card text", "required": True}),
                    202: (
                    ...
                    205: (
                        ...
                        [
                            [
                                ...
                                ("top_right_title", 194),
                                ("top_right_text", 195),
                                ("top_right_button_label", 196),
                                ("top_right_page_link", 197),
                                ("top_right_url_link", 198),
                                ("bottom_right_image", 199),
                                ("bottom_right_title", 200),
                                ("bottom_right_text", 201),
                                ("bottom_right_button_label", 202),
                                ("bottom_right_page_link", 203),
                                ("bottom_right_url_link", 204),
                            ]
                        ],
                    ...
                    210: (
                        "wagtail.blocks.StructBlock",
                        [[("main_card", 207), ("secondary_card", 208), ("tertiary_card", 209)]],
                    ...
                    212: (
                        "wagtail.blocks.StructBlock",
                        [[("main_card", 211), ("secondary_card", 208), ("tertiary_card", 209)]],
