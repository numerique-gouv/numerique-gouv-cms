...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("numerique_gouv", "0090_numeriquecatalogindexpage"),
    ]
        ...
        migrations.AlterField(
            ...
            field=wagtail.fields.StreamField(
                [
                    ...
                    ("multicolumns", 176),
                    ("item_grid", 179),
                    ("fullwidthbackground", 192),
                    ("fullwidthbackgroundwithsidemenu", 199),
                    ("subpageslist", 200),
                    ("blog_recent_entries", 183),
                    ("events_recent_entries", 202),
                    ("three_cards", 220),
                    ("numeric_direction_card", 221),
                    ("spacer", 186),
                    ("stylized_column", 174),
                    ("highlight_cards", 225),
                    ("vertical_highlight_cards", 227),
                    ("slider", 190),
                ],
                blank=True,
                block_lookup={
                    ...
                    157: (
                        "wagtail.blocks.StructBlock",
                        [[("title", 1), ("heading_tag", 2), ("heading_size", 155), ("title_color_class", 156)]],
                        {"group": "Numerique components", "label": "Title"},
                    ),
                    158: ("wagtail.images.blocks.ImageChooserBlock", (), {"label": "Image", "required": True}),
                    159: ("wagtail.blocks.CharBlock", (), {"label": "Alt text", "required": True}),
                    160: ("wagtail.blocks.RichTextBlock", (), {"label": "Text", "required": True}),
                    161: ("wagtail.blocks.PageChooserBlock", (), {"label": "Main link", "required": True}),
                    162: (
                        "wagtail.blocks.URLBlock",
                        (),
                    ...
                    163: (
                        "wagtail.blocks.StructBlock",
                        [[("image", 158), ("alt", 159), ("text", 160), ("main_link", 161), ("secondary_link", 162)]],
                    ...
                    168: (
                        "wagtail.blocks.StructBlock",
                        [[("column_width", 164), ("horizontal_align", 165), ("vertical_align", 166), ("items", 167)]],
                    ...
                    170: (
                        "wagtail.blocks.StructBlock",
                        [[("width", 154), ("content", 169)]],
                        {"group": "Page structure", "label": "Custom adjustable column", "required": False},
                    ),
                    171: ("wagtail.blocks.BooleanBlock", (), {"label": "Border", "required": False}),
                    172: ("wagtail.blocks.BooleanBlock", (), {"label": "Center content", "required": False}),
                    173: (
                        "wagtail.blocks.StreamBlock",
                        [
                            [
                    ...
                    174: (
                        "wagtail.blocks.StructBlock",
                        [[("bg_color_class", 148), ("border", 171), ("center_content", 172), ("content", 173)]],
                    ...
                    179: (
                        ...
                        [
                            [
                                ("column_width", 164),
                                ("horizontal_align", 165),
                                ("vertical_align", 166),
                                ("items", 177),
                                ("numbers_items_to_display", 178),
                            ]
                        ],
                        {"group": "Page structure", "label": "Item grid"},
                    ),
                    ...
                    190: (
                        "wagtail.blocks.StructBlock",
                        [[("title", 1), ("title_heading_tag", 187), ("title_heading_size", 188), ("blocks", 189)]],
                    ...
                    191: (
                        ...
                        [
                            [
                                ...
                                ("item_grid", 168),
                                ("numeric_direction_card", 163),
                                ("custom_ajustable_column", 170),
                                ("horizontal_card", 103),
                                ("multicolumns", 184),
                                ("stylized_column", 174),
                                ("spacer", 186),
                                ("custom_item_grid", 179),
                                ("slider", 190),
                            ]
                        ],
                        {"label": "Content"},
                    ...
                    194: ("wagtail.blocks.CharBlock", (), {"label": "Side menu title", "required": False}),
                    195: (
                        "wagtail.blocks.RawHTMLBlock",
                        (),
                        {
                    ...
                    196: ("wagtail.blocks.PageChooserBlock", (), {"label": "Parent page"}),
                    197: ("wagtail.blocks.StructBlock", [[("page", 196)]], {"label": "Page tree"}),
                    198: (
                        "wagtail.blocks.StreamBlock",
                        [[("html", 195), ("pagetree", 197)]],
                    ...
                    204: ("wagtail.blocks.TextBlock", (), {"label": "Main card title", "required": True}),
                    205: ("wagtail.blocks.RichTextBlock", (), {"label": "Main card text", "required": True}),
                    206: (
                        "wagtail.blocks.PageChooserBlock",
                        (),
                    ...
                    209: ("wagtail.blocks.TextBlock", (), {"label": "Top right card title", "required": False}),
                    210: ("wagtail.blocks.RichTextBlock", (), {"label": "Top right card text", "required": True}),
                    211: ("wagtail.blocks.TextBlock", (), {"label": "Top right card button label", "required": False}),
                    212: (
                        "wagtail.blocks.PageChooserBlock",
                        (),
                    ...
                    215: ("wagtail.blocks.TextBlock", (), {"label": "Bottom right card title", "required": False}),
                    216: ("wagtail.blocks.RichTextBlock", (), {"label": "Bottom right card text", "required": True}),
                    217: (
                    ...
                    220: (
                        ...
                        [
                            [
                                ...
                                ("top_right_title", 209),
                                ("top_right_text", 210),
                                ("top_right_button_label", 211),
                                ("top_right_page_link", 212),
                                ("top_right_url_link", 213),
                                ("bottom_right_image", 214),
                                ("bottom_right_title", 215),
                                ("bottom_right_text", 216),
                                ("bottom_right_button_label", 217),
                                ("bottom_right_page_link", 218),
                                ("bottom_right_url_link", 219),
                            ]
                        ],
                    ...
                    225: (
                        "wagtail.blocks.StructBlock",
                        [[("main_card", 222), ("secondary_card", 223), ("tertiary_card", 224)]],
                    ...
                    227: (
                        "wagtail.blocks.StructBlock",
                        [[("main_card", 226), ("secondary_card", 223), ("tertiary_card", 224)]],
