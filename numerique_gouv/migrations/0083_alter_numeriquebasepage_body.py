# Generated by Django 5.0.9 on 2024-11-30 19:14
...
class Migration(migrations.Migration):
    dependencies = [
        ("numerique_gouv", "0082_alter_sitemappage_options"),
    ]
        ...
        migrations.AlterField(
            ...
            field=wagtail.fields.StreamField(
                [
                    ...
                    ("events_recent_entries", 182),
                    ("html", 183),
                    ("three_cards", 201),
                    ("numeric_direction_card", 202),
                    ("spacer", 170),
                    ("stylized_column", 159),
                    ("highlight_cards", 206),
                    ("vertical_highlight_cards", 208),
                    ("slider", 213),
                ],
                blank=True,
                block_lookup={
                    ...
                    172: (
                        "wagtail.blocks.StructBlock",
                        [[("bg_image", 136), ("bg_color_class", 137), ("content", 171)]],
                    ...
                    185: ("wagtail.blocks.TextBlock", (), {"label": "Main card title", "required": True}),
                    186: ("wagtail.blocks.RichTextBlock", (), {"label": "Main card text", "required": True}),
                    187: (
                        "wagtail.blocks.PageChooserBlock",
                        (),
                    ...
                    190: ("wagtail.blocks.TextBlock", (), {"label": "Top right card title", "required": False}),
                    191: ("wagtail.blocks.RichTextBlock", (), {"label": "Top right card text", "required": True}),
                    192: ("wagtail.blocks.TextBlock", (), {"label": "Top right card button label", "required": False}),
                    193: (
                        "wagtail.blocks.PageChooserBlock",
                        (),
                    ...
                    196: ("wagtail.blocks.TextBlock", (), {"label": "Bottom right card title", "required": False}),
                    197: ("wagtail.blocks.RichTextBlock", (), {"label": "Bottom right card text", "required": True}),
                    198: (
                    ...
                    201: (
                        ...
                        [
                            [
                                ...
                                ("top_right_title", 190),
                                ("top_right_text", 191),
                                ("top_right_button_label", 192),
                                ("top_right_page_link", 193),
                                ("top_right_url_link", 194),
                                ("bottom_right_image", 195),
                                ("bottom_right_title", 196),
                                ("bottom_right_text", 197),
                                ("bottom_right_button_label", 198),
                                ("bottom_right_page_link", 199),
                                ("bottom_right_url_link", 200),
                            ]
                        ],
                    ...
                    206: (
                        "wagtail.blocks.StructBlock",
                        [[("main_card", 203), ("secondary_card", 204), ("tertiary_card", 205)]],
                    ...
                    208: (
                        "wagtail.blocks.StructBlock",
                        [[("main_card", 207), ("secondary_card", 204), ("tertiary_card", 205)]],
                        {"group": "Numerique components", "label": "Vertical Highlight cards"},
                    ),
                    209: ("wagtail.blocks.CharBlock", (), {"label": "Title", "required": True}),
                    210: (
                        "wagtail.blocks.ChoiceBlock",
                        [],
                        {
                    ...
                    213: (
                        "wagtail.blocks.StructBlock",
                        [[("title", 209), ("title_heading_tag", 210), ("title_heading_size", 211), ("blocks", 212)]],
