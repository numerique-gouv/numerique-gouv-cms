...
class Migration(migrations.Migration):
    dependencies = [
        ("numerique_gouv", "0004_alter_numeriquebasepage_body"),
    ]
                    ...
                    (
                        ...
                        wagtail.blocks.StructBlock(
                            [
                                ...
                                ("icon_class", content_manager.blocks.IconPickerBlock(label="Icon", required=False)),
                                (
                                    "text",
                    ...
                    (
                        ...
                        wagtail.blocks.StructBlock(
                            [
                                ...
                                (
                                    "top_detail_icon",
                                    content_manager.blocks.IconPickerBlock(label="Top detail: icon", required=False),
                                ),
                                (
                    ...
                    (
                        ...
                        wagtail.blocks.StructBlock(
                            [
                                (
                                    "main_image",
                                    wagtail.images.blocks.ImageChooserBlock(label="Main card image", required=True),
                                ),
                                ("main_title", wagtail.blocks.TextBlock(label="Main card title", required=True)),
                                ("main_text", wagtail.blocks.RichTextBlock(label="Main card text", required=True)),
                                (
                                    "main_page_link",
                                    wagtail.blocks.PageChooserBlock(
                                ...
                                (
                                    "top_right_title",
                                    wagtail.blocks.TextBlock(label="Top right card title", required=False),
                                ),
                                (
                                    "top_right_text",
                                    wagtail.blocks.RichTextBlock(label="Top right card text", required=True),
                                ),
                                (
                                    "top_right_button_label",
                                    wagtail.blocks.TextBlock(label="Top right card button label", required=False),
                                ),
                                (
                                    "top_right_page_link",
                                    wagtail.blocks.PageChooserBlock(
                                ...
                                (
                                    "bottom_right_title",
                                    wagtail.blocks.TextBlock(label="Bottom right card title", required=False),
                                ),
                                (
                                    "bottom_right_text",
                                    wagtail.blocks.RichTextBlock(label="Bottom right card text", required=True),
                                ),
                                (
                                    "bottom_right_button_label",
                                    wagtail.blocks.TextBlock(label="Bottom right card button label", required=False),
                                ),
                                (
                                    "bottom_right_page_link",
                                    wagtail.blocks.PageChooserBlock(
