# Generated by Django 5.0.10 on 2025-03-13 14:16
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("numerique_gouv", "0088_alter_numeriquebasepage_body"),
    ]
        ...
        migrations.AlterField(
            ...
            field=wagtail.fields.StreamField(
                [
                    ...
                    ("subpageslist", 193),
                    ("blog_recent_entries", 176),
                    ("events_recent_entries", 195),
                    ("three_cards", 213),
                    ("numeric_direction_card", 214),
                    ("spacer", 179),
                    ("stylized_column", 167),
                    ("highlight_cards", 218),
                    ("vertical_highlight_cards", 220),
                    ("slider", 183),
                ],
                blank=True,
                block_lookup={
                    ...
                    172: (
                        "wagtail.blocks.StructBlock",
                        [[("column_width", 159), ("items", 170), ("numbers_items_to_display", 171)]],
                        {"group": "Page structure", "label": "Item grid"},
                    ),
                    173: (
                        "wagtail.blocks.PageChooserBlock",
                    ...
                    183: (
                        "wagtail.blocks.StructBlock",
                        [[("title", 1), ("title_heading_tag", 180), ("title_heading_size", 181), ("blocks", 182)]],
                    ...
                    185: (
                        "wagtail.blocks.StructBlock",
                        [[("bg_image", 144), ("bg_color_class", 145), ("content", 184)]],
                    ...
                    197: ("wagtail.blocks.TextBlock", (), {"label": "Main card title", "required": True}),
                    198: ("wagtail.blocks.RichTextBlock", (), {"label": "Main card text", "required": True}),
                    199: (
                        "wagtail.blocks.PageChooserBlock",
                        (),
                    ...
                    202: ("wagtail.blocks.TextBlock", (), {"label": "Top right card title", "required": False}),
                    203: ("wagtail.blocks.RichTextBlock", (), {"label": "Top right card text", "required": True}),
                    204: ("wagtail.blocks.TextBlock", (), {"label": "Top right card button label", "required": False}),
                    205: (
                        "wagtail.blocks.PageChooserBlock",
                        (),
                    ...
                    208: ("wagtail.blocks.TextBlock", (), {"label": "Bottom right card title", "required": False}),
                    209: ("wagtail.blocks.RichTextBlock", (), {"label": "Bottom right card text", "required": True}),
                    210: (
                    ...
                    213: (
                        ...
                        [
                            [
                                ...
                                ("top_right_title", 202),
                                ("top_right_text", 203),
                                ("top_right_button_label", 204),
                                ("top_right_page_link", 205),
                                ("top_right_url_link", 206),
                                ("bottom_right_image", 207),
                                ("bottom_right_title", 208),
                                ("bottom_right_text", 209),
                                ("bottom_right_button_label", 210),
                                ("bottom_right_page_link", 211),
                                ("bottom_right_url_link", 212),
                            ]
                        ],
                    ...
                    218: (
                        "wagtail.blocks.StructBlock",
                        [[("main_card", 215), ("secondary_card", 216), ("tertiary_card", 217)]],
                    ...
                    220: (
                        "wagtail.blocks.StructBlock",
                        [[("main_card", 219), ("secondary_card", 216), ("tertiary_card", 217)]],
