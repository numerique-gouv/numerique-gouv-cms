                    ...
                    wagtail.fields.StreamField(
                        [
                            ...
                            (
                                ...
                                wagtail.blocks.StructBlock(
                                    [
                                        ("carte_une_titre", wagtail.blocks.TextBlock(required=True)),
                                        ("carte_une_texte", wagtail.blocks.RichTextBlock(required=True)),
                                        ("carte_une_lien_page", wagtail.blocks.PageChooserBlock(required=False)),
                                        ("carte_une_lien_url", wagtail.blocks.URLBlock(required=False)),
                                        ("carte_une_image", wagtail.images.blocks.ImageChooserBlock(required=True)),
                                        ("carte_deux_label_bouton", wagtail.blocks.TextBlock(required=True)),
                                        ("carte_deux_texte", wagtail.blocks.RichTextBlock(required=True)),
                                        ("carte_deux_lien_page", wagtail.blocks.PageChooserBlock(required=False)),
                                        ("carte_deux_lien_url", wagtail.blocks.URLBlock(required=False)),
                                        ("carte_deux_image", wagtail.images.blocks.ImageChooserBlock(required=True)),
                                        ("carte_trois_label_bouton", wagtail.blocks.TextBlock(required=True)),
                                        ("carte_trois_texte", wagtail.blocks.RichTextBlock(required=True)),
                                        ("carte_trois_lien_page", wagtail.blocks.PageChooserBlock(required=False)),
                                        ("carte_trois_lien_url", wagtail.blocks.URLBlock(required=False)),
                                        ("carte_trois_image", wagtail.images.blocks.ImageChooserBlock(required=True)),
                                    ],
                                    label="Trois cartes",
                                ),
                            ),
